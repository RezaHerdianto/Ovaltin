                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <!-- WhatsApp -->
                            <a href="#" class="flex items-center justify-center w-12 h-12 bg-white/20 rounded-full hover:bg-white/30 hover:scale-110 transition duration-200 border border-white/30">
                                <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
