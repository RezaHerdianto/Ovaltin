...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-pink-500 to-rose-600 flex-col justify-center px-12">
            <!-- Logo -->
            ...
            <form class="space-y-6" action="{{ route('register') }}" method="POST">
                ...
                <div>
                    ...
                    <input id="name" name="name" type="text" autocomplete="name" required 
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 @error('name') border-red-300 @enderror">
                    @error('name')
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required
                            ...
                            class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500">
                ...
                <div>
                    <button type="submit"
                        class="w-full bg-gradient-to-r from-pink-500 to-rose-600 text-white py-3 px-4 rounded-lg font-medium hover:from-pink-600 hover:to-rose-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 transition duration-200">
                        Daftar
                    </button>
                </div>
            </form>
