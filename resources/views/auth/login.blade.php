...
<body class="font-sans antialiased bg-gray-50">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative flex-col justify-center px-12 overflow-hidden">
            <!-- Background Image -->
            <div class="absolute inset-0 z-0">
                <img src="{{ asset('images/strawberry-farm.webp') }}" alt="Strawberry Farm" class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-pink-500/70 z-10"></div>
            </div>
            <!-- Content -->
            <div class="relative z-20">
                ...
                <div class="text-center text-white mb-8">
                    ...
                    <p class="text-xl text-white/90">Ovaltin menghadirkan strawberry berkualitas langsung dari kebun terbaik Indonesia untuk pengalaman rasa yang tak terlupakan.</p>
                </div>
                ...
                <div class="flex justify-center space-x-4">
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4 text-center">
                        ...
                        <p class="text-white text-sm font-medium leading-tight">Kualitas Terjamin</p>
                    </div>
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4 text-center">
                        <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center mx-auto mb-2">
                            <svg class="w-5 h-5 text-pink-600" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <p class="text-white text-sm font-medium leading-tight">Segar Langsung dari Kebun</p>
                    </div>
                    <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4 text-center">
                        <div class="w-8 h-8 bg-white rounded-full flex items-center justify-center mx-auto mb-2">
                            <svg class="w-5 h-5 text-pink-600" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <p class="text-white text-sm font-medium leading-tight">Harga Terbaik & Manfaat Optimal</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-8 py-12">
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" name="password" type="password" autocomplete="current-password" required
                            ...
                            class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 @error('password') border-red-300 @enderror">
                ...
                <div>
                    <button type="submit"
                        class="w-full bg-pink-500 text-white py-3 px-4 rounded-lg font-medium hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 transition duration-200">
                        Masuk
                    </button>
                </div>
            </form>
