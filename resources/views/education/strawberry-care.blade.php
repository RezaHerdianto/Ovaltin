...
<div class="max-w-screen-xl mx-auto space-y-10 px-4 sm:px-6 lg:px-8 pb-16">
    <header class="relative overflow-hidden rounded-3xl bg-white text-slate-900 shadow-xl mt-10 border border-slate-100">
        ...
        <div class="absolute inset-0 pointer-events-none" aria-hidden="true">
            <div class="absolute -left-10 -top-10 w-60 h-60 bg-sky-100 rounded-full blur-3xl opacity-60"></div>
            <div class="absolute -right-16 bottom-0 w-72 h-72 bg-indigo-100 rounded-full blur-3xl opacity-60"></div>
        </div>
        <div class="relative grid lg:grid-cols-2 gap-10 p-10 items-center">
            <div class="space-y-4">
                <div class="inline-flex items-center px-3 py-1 rounded-full bg-sky-100 text-sky-700 text-xs font-semibold uppercase tracking-wide border border-sky-200">
                    Panduan Praktis
                </div>
            ...
            <div class="relative">
                <div class="absolute -inset-4 rounded-3xl bg-sky-200/40 blur-3xl"></div>
        ...
        <div class="grid lg:grid-cols-12 gap-8">
            <div class="lg:col-span-8 space-y-8">
                <section class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 md:p-8">
                    ...
                    <div class="inline-flex items-center px-4 py-2 rounded-full bg-sky-50 text-sky-700 text-sm font-semibold border border-sky-100">
                        Mode praktis: 3 poin inti
                    </div>
                </div>
                <div class="grid md:grid-cols-3 gap-4">
                    <div class="rounded-xl bg-gradient-to-br from-sky-50 to-white border border-sky-100 p-4 shadow-sm">
                        <h3 class="text-sm font-semibold text-sky-800 mb-2">Irigasi</h3>
                        <p class="text-slate-700 text-sm leading-relaxed">
                            Siram ringan 2–3x/minggu, hindari genangan, gunakan mulsa supaya lembap stabil.
                        </p>
                    </div>
                    <div class="rounded-xl bg-gradient-to-br from-indigo-50 to-white border border-indigo-100 p-4 shadow-sm">
                        <h3 class="text-sm font-semibold text-indigo-800 mb-2">Nutrisi</h3>
                        <p class="text-slate-700 text-sm leading-relaxed">
                ...
                <section class="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 md:p-8 space-y-6">
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            <span class="h-10 w-10 flex items-center justify-center rounded-full bg-sky-100 text-sky-700 font-bold">1</span>
                            <div>
                        ...
                        <div class="flex items-start gap-3">
                            <span class="h-10 w-10 flex items-center justify-center rounded-full bg-indigo-100 text-indigo-700 font-bold">2</span>
                            <div>
            ...
            <aside class="lg:col-span-4 space-y-6">
                <div class="rounded-2xl bg-gradient-to-br from-indigo-500 to-sky-600 text-white shadow-xl p-6 border border-white/10">
    ...
    <div class="bg-white rounded-3xl shadow-xl border border-slate-100 p-6 md:p-10">
        ...
        <div class="grid md:grid-cols-3 gap-5">
            ...
            <div class="rounded-2xl border border-indigo-100 bg-indigo-50 p-5">
                <h3 class="text-lg font-semibold text-indigo-900 mb-2">Pengendalian Serangga</h3>
                <ul class="text-sm text-indigo-900/80 space-y-2">
