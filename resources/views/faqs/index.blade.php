...
<div class="space-y-6">
                ...
                <div class="space-y-4">
                    @foreach($faqs as $index => $faq)
                        <div class="border-2 border-pink-100 rounded-xl overflow-hidden hover:border-pink-300 transition-all duration-200" x-data="{ open: {{ $index === 0 ? 'true' : 'false' }} }">
                            ...
                            <button 
                                @click="open = !open"
                                class="w-full px-6 py-4 bg-gradient-to-r from-pink-50 to-rose-50 hover:from-pink-100 hover:to-rose-100 transition-all duration-200 flex items-center justify-between text-left"
                            >
                                <div class="flex items-center space-x-4 flex-1">
                                    <div class="flex-shrink-0 w-8 h-8 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full flex items-center justify-center text-white font-bold">
                                        {{ $index + 1 }}
                                    </div>
    ...
    <div class="bg-gradient-to-r from-pink-50 to-rose-50 rounded-xl p-6 border-2 border-pink-100">
        <div class="text-center">
            ...
            <a href="{{ route('contact.index') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white font-semibold rounded-lg hover:from-pink-600 hover:to-rose-600 transition-all duration-200 shadow-lg hover:shadow-xl">
