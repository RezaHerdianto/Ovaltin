...
<body class="bg-red-600">
                    ...
                    @if (Route::has('login'))
                        @auth
                            @if(auth()->user()->isAdmin())
                                <a href="{{ route('admin.dashboard') }}" class="px-4 py-2 text-gray-700 hover:text-red-600 transition">Dashboard Admin</a>
                            @else
                                <a href="{{ route('dashboard') }}" class="px-4 py-2 text-gray-700 hover:text-red-600 transition">Dashboard</a>
                            @endif
                        @else
    ...
    <div class="bg-red-600 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-xl text-red-100 mb-8">Bergabunglah dengan ribuan pelanggan puas kami</p>
            @guest
                <a href="{{ route('register') }}" class="inline-block px-8 py-3 bg-white text-red-600 rounded-lg font-semibold hover:bg-gray-100 transition transform hover:scale-105">
                    Daftar Sekarang
                </a>
            @endguest
        </div>
